...
from languages.models import Language, Paradigm, Programmer, Framework, the_most_popular_language


class ChangesInParadigmUpdatedInLanguage(TestCase):
    """
...
class ChangesInLanguageUpdatedInFramework(TestCase):
    """
...
class ChangesInLanguageUpdatedInProgrammer(TestCase):
    """
    Integration test module for checking the changes in the language instance
...
class NumberAndListOfLanguagesUpdatedWhenChanges(TestCase):
    """
...
class NumberAndListOfProgrammersUpdatedWhenChanges(TestCase):
    """
...
class NumberAndListOfFrameworksUpdatedWhenChanges(TestCase):
    """
